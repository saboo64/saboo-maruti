...
function Dzire() {
  ...
  return (
    <>
      ...
      />
      <img
        src={require("../../assets/banners/vehicles/banners-2024/Website_Mobile_Maruti_Suzuki_Arena_New_Dazzling_Dzire_with_Five_Star_Rating_Car_Offers_Saboo_RKS_Motor.webp")}
        alt="Website_Maruti_Suzuki_Arena_New_Dazzling_Dzire_with_Five_Star_Rating_Car_Offers_Saboo_RKS_Motor"
      ...
      <div>
        {" "}
        <img
          src={require("../../assets/banners/vehicles/Dazzling New Dzire Single page Brochure1-01.webp")}
        ...
        <div className="my-auto">
          ...
          <div className="flex flex-wrap items-center mt-5 mb-2 text-blue-800">
            ...
            <div className="flex items-center mx-3 mb-1 space-x-3">
              ...
              <p className="text-sm">
                Mileage <br />
                <span className="font-semibold">33.73 km/kg*</span>
              </p>
            </div>
          ...
          <div className="flex flex-col items-center space-y-2 md:flex-row md:space-y-0 md:space-x-2 md:mt-5 md:mb-1 ">
            <a
              href="https://images-saboomaruti-in.s3.ap-south-1.amazonaws.com/Dzire+Saboo+RKS+brochure+2025.pdf"
              target="_blank"
              rel="noopener noreferrer"
