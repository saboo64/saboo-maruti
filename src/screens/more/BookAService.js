    ...
    <>
      ...
      {/* {serviceCenterBanner.map((item, index) => (
        <img
          src={item.img}
          key={index}
          alt="Maruti Suzuki Arena Hyderabad September Monsoon 2024 Book Your Car for Service"
      ...
      />
       ...
       // src={require("../../assets/banners/vehicles/banners-2024/Website_Mobile_Maruti_Suzuki_Service_October_Dussehra_Navratri_Offers_Saboo_RKS_Motor.webp")}
        alt="Maruti Suzuki Service October Dussehra Navratri Offers Saboo RKS Motor"
