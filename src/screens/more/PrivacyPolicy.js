...
function PrivacyPolicy() {
  return (
    <>
      <Helmet>
        <title>Privacy Policy of Maruti Cars | Saboo Maruti</title>
        <meta
          name="title"
          content="Privacy Policy of Maruti Cars | Saboo Maruti"
        />
        <meta
          name="description"
        ...
        <meta
          property="og:image"
          content="https://images-saboomaruti-in.s3.ap-south-1.amazonaws.com/Arena/about/Maruti+Suzuki+Arena+Saboo+RKS+Maruti+OG+Tag+Image.webp"
        />
      ...
      <div className="container px-5 mx-auto">
        ...
        <div className="my-4 space-y-1">
          <h5 className="font-semibold">
            Saboo RKS Maruti Suzuki Statement of Privacy Policy
          </h5>
          <p className="text-sm">
