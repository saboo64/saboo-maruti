  ...
  return (
    <>
      ...
      <div className="container mx-auto py-5 rounded-lg" id="payments">
        <div className="mt-4 md:mt-0 bg-gray-100  rounded-lg p-7 ">
          <div class="gap-6 items-center py-6 px-2 mx-auto max-w-screen-xl xl:gap-14 md:grid md:grid-cols-1 sm:py-14 lg:px-4">
            {/* <img
              src='https://images-saboomaruti-in.s3.ap-south-1.amazonaws.com/payment-system/saboo-rks-qrcode.webp'
              className='w-96'
              alt='dashboard'
            /> */}
            <div className="mt-3 mb-2 md:mt-0 bg-gray-100  rounded-lg">
